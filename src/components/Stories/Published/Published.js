    ...
    <>
      {stories.map((item) => {
        if (item.id === location.pathname.split("/").at(-1)) {
          return (
            <>
              <div className="published d-flex justify-content-between">
                <div className="published__header">
                  <Header />
                </div>

                <div className="published__center">
                  <div className="user d-flex align-items-center justify-content-between">
                    <div className="user__left d-flex align-items-center">
                      <div>
                        <img className="user__avatar" src={logo} alt="logo" />
                      </div>
                      <div className="user__name-div">
                        <p className="user__name m-0">Muhammadsodiq Koziyev</p>
                        <div className="user__reads d-flex align-items-center">
                          <span className="user__span">1 min ago</span>
                          <span className="user__span">2 min read</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <p className="published__desc">{item.decs}</p>
                  <div className="d-flex align-items-center justify-content-between pt-5">
                    <div>
                      <svg
                      className="published__icon me-4"
                        width={24}
                        height={24}
                        viewBox="0 0 24 24"
                        aria-label="clap"
                    ...
                    <div className="d-flex align-items-center">
                      <svg
                      className="me-3 published__icon"
                        width={24}
                        height={24}
                        viewBox="0 0 24 24"
                        fill="none"
                  ...
                  <div className="published__more">
                      <p className="published__title">
                        More from Muhammadsodiq Koziyev
                      </p>

                      <div className="published__love d-flex align-items-center">
                        <p className="published__love-p">
                        Love podcasts or audiobooks? Learn on the go with our new app.
                        </p>
                        <button className="published__btn">
                          Try Knowble
                        </button>
                      </div>
                  </div>
                ...
                <div className="published__unlimite">
                  <Unlimites />
                </div>
              </div>
            </>
